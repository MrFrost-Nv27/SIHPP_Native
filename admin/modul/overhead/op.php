...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="index.php?page=overhead&act=tambah" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                    ...
                    foreach ($data as $bb) : ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="?page=overhead&act=edit&id=<?= $bb['id_overp'] ?>"
                                        class="btn btn-warning btn-circle">
                                        <i class="fas fa-pen"></i>
                                    </a>
                                    <a href="<?= $aksi ?>?page=aksi_op&act=hapus&id=<?= $bb['id_overp'] ?>"
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                ...
                <form class='form-horizontal' id='registerHere' method='post'
                    action='<?php echo $aksi; ?>?page=aksi_overhead&act=input'>
                    <div class="box-body">
                    ...
                    <div class="box-footer" style="margin-left:-10px;">
                        <div class="col-sm-10 col-sm-offset-2">
                            ...
                            <a href="index.php?page=overhead&act=list" class="btn btn-danger" role="button"><i
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <form class='form-horizontal' id='registerHere' method='post'
                    action='<?php echo $aksi; ?>?page=aksi_overhead&act=edit'>
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="nm_overp" placeholder="Nama Overhead"
                                    value="<?php echo $nm_overp; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" name="by_overp" placeholder="0"
                                        value="<?php echo $by_overp; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="ket_overp" placeholder="Keterangan"
                                    value="<?php echo $ket_overp; ?>">
                            </div>
                        </div>
                    </div>
                    <!-- /.box-body -->
