...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="index.php?page=tenaker&act=tambah" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                    ...
                    foreach ($data as $bb) : ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="?page=tenaker&act=edit&id=<?= $bb['id_tenaker'] ?>"
                                        class="btn btn-warning btn-circle">
                                        <i class="fas fa-pen"></i>
                                    </a>
                                    <a href="<?= $aksi ?>?page=aksi_tenaker&act=hapus&id=<?= $bb['id_tenaker'] ?>"
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                ...
                <form class='form-horizontal' id='registerHere' method='post'
                    action='<?php echo $aksi; ?>?page=aksi_tenaker&act=input'>
                    <div class="box-body">
                    ...
                    <div class="box-footer" style="margin-left:-10px;">
                        <div class="col-sm-10 col-sm-offset-2">
                            ...
                            <a href=index.php?page=tenaker&act=list><button type="button" class="btn btn-danger"><i
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <form class='form-horizontal' id='registerHere' method='post'
                    action='<?= $aksi; ?>?page=aksi_tenaker&act=edit'>
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="nm_tenaker" placeholder="Nama Lengkap"
                                    value="<?php echo $nm_tenaker; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4 selectContainer">
                                <select class="form-control" name="bag_tenaker">
                                    <option value="<?php echo $bag_tenaker; ?>"
                                        style="color:white; background-color:light-blue;"><?php echo $bag_tenaker; ?>
                                    </option>
                                    <option value="Kusen Pintu">Tukang Kusen Pintu</option>
                                    <option value="Meja">Tukang Meja</option>
                                    <option value="Kursi">Tukang Kursi</option>
