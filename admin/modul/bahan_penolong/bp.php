...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="index.php?page=bp&act=tambah" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                    ...
                    foreach ($data as $bb) : ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="?page=bp&act=edit&id=<?= $bb['id_bp'] ?>"
                                        class="btn btn-warning btn-circle">
                                        <i class="fas fa-pen"></i>
                                    </a>
                                    <a href="<?= $aksi ?>?page=aksi_bp&act=hapus&id=<?= $bb['id_bp'] ?>"
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                ...
                <form class='form-horizontal' id='registerHere' method='post'
                    action='<?php echo $aksi; ?>?page=aksi_bp&act=input'>
                    <div class="box-body">
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <form class='form-horizontal' id='registerHere' method='post'
                    action='<?php echo $aksi; ?>?page=aksi_bp&act=edit'>
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            <label for="satu" class="col control-label">Nama Bahan Penolong</label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="nm_bp" placeholder="Nama Bahan Penolong"
                                    value="<?php echo $nm_bp; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="dua" class="col control-label">Harga Bahan Penolong</label>
                            <div class="col-sm-4">
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" name="hrg_bp" placeholder="0"
                                        value="<?php echo $hrg_bp; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="box-footer" style="margin-left:-10px;">
                        <div class="col-sm-10 col-sm-offset-2">
                            <button type="submit" class="btn btn-primary"><i class="fa fa-floppy-o"
                                    aria-hidden="true"></i> Simpan</button>
                            <a href=index.php?page=bp&act=list><button type="button" class="btn btn-danger"><i
