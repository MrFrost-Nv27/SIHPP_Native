                    ...
                    foreach ($data as $bb) : ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="?page=bb&act=edit&id=<?= $bb['id_bb'] ?>"
                                        class="btn btn-warning btn-circle">
                                        <i class="fas fa-pen"></i>
                                    </a>
                                    <a href="<?= $aksi ?>?page=aksi_bb&act=hapus&id=<?= $bb['id_bb'] ?>"
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                ...
                <form class='form-horizontal' id='registerHere' method='post'
                    action='<?php echo $aksi; ?>?page=aksi_bb&act=input'>
                    <div class="box-body">
                    ...
                    <div class="box-footer" style="margin-left:-10px;">
                        <div class="col-sm-10 col-sm-offset-2">
                            ...
                            <a href=index.php?page=bb&act=list><button type="button" class="btn btn-danger"><i
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <form class='form-horizontal' id='registerHere' method='post'
                    action='<?php echo $aksi; ?>?page=aksi_bb&act=edit'>
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            <label for="satu" class="col-sm-2 control-label">Nama Bahan Baku</label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="nm_bb" placeholder="Nama Bahan Baku"
                                    value="<?php echo $nm_bb; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="dua" class="col-sm-2 control-label">Harga Bahan Baku</label>
                            <div class="col-sm-4">
                                <input type="number" class="form-control" name="hrg_bb" placeholder="0"
                                    value="<?php echo $hrg_bb; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="tiga" class="col-sm-2 control-label">Satuan</label>
