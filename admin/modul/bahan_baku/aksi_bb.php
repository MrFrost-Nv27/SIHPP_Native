...
mysqli_query($koneksi,"INSERT into bahan_baku values('','BB','$nm_bb','$hrg_bb','$satuan_bb')");
...
mysqli_query($koneksi,"UPDATE persediaan_bahan_baku SET nm_pb = '$nm_bb', hrg_pb  = '$hrg_bb', sat_pb  = '$satuan_bb', tot_pb= hrg_pb * stok_pb WHERE kd_pb = '$kd_bb'");
header('location:../../index.php?page=bb&act=list');
