                                ...
                                <form class='form-horizontal' id='registerHere' method='post' action='<?php echo $aksi; ?>?page=aksi_stok_bb&act=edit'>
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" name="stok_asli" placeholder="Jumlah Bahan" value="<?= $bahan_baku['stok_pb']; ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="satu" class="col-sm-3 control-label">Tambah Jumlah Bahan</label>
                                            <div class="col-sm-4">
                                                <input type="number" class="form-control" name="stok_tambah" placeholder="Jumlah Bahan" value="0">
                                            </div>
                                        </div>
                                        <!-- /.box-body -->
                                        <div class="box-footer" style="margin-left:-15px;">
                                            <div class="col-sm-10 col-sm-offset-3">
                                                ...
                                                <a role="button" class="btn btn-danger" href="index.php?page=stok_bb&act=list"><i class="fa fa-ban"></i> Batal</button></a>
                                            </div>
                                        </div>
                                        <!-- /.box-footer -->
                                </form>
                                        ...
                                        foreach ($data as $bb) : ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="?page=stok_bb&act=tambah&id=<?= $bb['id_bb'] ?>" class="btn btn-success btn-circle">
                                                        <i class="fas fa-plus"></i>
                                                    </a>
                                                    <a href="?page=stok_bb&act=lihat&id=<?= $bb['id_bb'] ?>" class="btn btn-info btn-circle">
