...
switch ($_GET['act']) {
  ...
  case "tambah":
    $edit = mysqli_query($koneksi, "SELECT * FROM persediaan_bahan_baku WHERE kd_pb ='$_GET[id]'");
...
?>
    <ol class="breadcrumb" style="background-color: white;">
      ...
      <li><a href="index.php?page=stok_bb&act=list">Daftar Persediaan Bahan Baku</a></li>
      <li class="active">Edit Data Stok <?php echo $kd_pb; ?></li>
    </ol>
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="box box-info">
          <div class="box-header with-border">
            <form class='form-horizontal' id='registerHere' method='post' action='<?php echo $aksi; ?>?page=aksi_stok_bb&act=edit'>
              ...
              <div class="box-footer" style="margin-left:-15px;">
                <div class="col-sm-10 col-sm-offset-3">
                  ...
                  <a href=index.php?page=stok_bb&act=list><button type="submit" class="btn btn-danger"><i class="fa fa-ban"></i> Batal</button></a>
                </div>
              </div>
              <!-- /.box-footer -->
            </form>
  ...
  ?>
    <ol class="breadcrumb" style="background-color: white;">
      <li><a href="#">Master Data</a></li>
      <li><a href="index.php?page=bb&act=list">Bahan Baku</a></li>
      <li class="active">Daftar Persediaan Bahan Baku</li>
    </ol>
    <div class="row">
      <div class="col-md-12">
        <div class="col-md-11"></div>
          ...
          <div class="box-header with-border">
            <div class="box-body">
              ...
              <table  id = "example1" class="table table-bordered table-striped">
                ...
                $sql = mysqli_query($koneksi, "SELECT * FROM persediaan_bahan_baku ORDER BY tgl_pb desc LIMIT $posisi, $batas");
                $no = $posisi + 1;
                ...
                <tr>
                  <td>' . $no . '</td>
                      ...
                      <td>';
                echo "
                      <a title = 'Tambah Stok' href=?page=stok_bb&act=tambah&id=$row[kd_pb]><button type='button' class='btn btn-success'><span class='glyphicon glyphicon-plus'></button></a>
                      <a title = 'Lihat Detail' href=?page=stok_bb&act=lihat&id=$row[kd_pb]><button type='button' class='btn btn-warning'><span class='glyphicon glyphicon-eye-open'></button></a>
                    </td>";
                echo '
              </tr>';
              $no++;
              }
              $jmldata                    = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM persediaan_bahan_baku"));
            ...
            <form class='form-horizontal' id='registerHere' method='post' action=''>
              ...
              <div class="box-footer" style="margin-left:-10px;">
                <div class="col-sm-10 col-sm-offset-2">
                  <a href=index.php?page=stok_bb&act=list><button type="button" class="btn btn-danger"><i class="glyphicon glyphicon-circle-arrow-left"></i> Kembali</button></a>
                </div>
              </div>
              <!-- /.box-footer -->
            </form>
